...
public class DAOUsuarioJDBC implements DAOUsuario {
	...
	private static final String SQL_INSERT = "INSERT INTO usuarios " + "(dni, email, password, nombre, apellidos)"
			+ "VALUES (?, ?, ?, ?, ?)";
	private static final String SQL_UPDATE = "UPDATE usuarios SET "
			+ "dni=?, email=?, password=?, nombre=?, apellidos=? " + "WHERE id=?";
	private static final String SQL_DELETE = "DELETE FROM usuarios WHERE id=?";

	private static final String SQL_SELECT = "SELECT id, dni, email, password, nombre, apellidos FROM usuarios ";
	private static final String SQL_SELECT_ID = "SELECT id, dni, email, password, nombre, apellidos "
			+ "FROM usuarios WHERE id=?";
	private static final String SQL_SELECT_EMAIL = "SELECT id, dni, email, password, nombre, apellidos "
	...
	public Usuario[] obtenerUsuarios() {
		...
		try {
			...
			while (rs.next()) {
				u = new Usuario(rs.getLong("id"), rs.getString("dni"), rs.getString("email"), rs.getString("password"),
