...
public class MainMejorado {
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		for (int i = 1; i <= 3; i++)
			daoProducto
					.alta(new Producto(i, "Producto" + i, "Descripción" + i, new BigDecimal("" + i + i + "." + i + i)));
		...
		Producto producto1 = new Producto(producto2.getId(), "Producto2", "Descripción2", new BigDecimal("22.22"));
	...
	public static void mainPruebaUsuarioJDBC(String[] args) {
		DAOUsuario daoUsuario = new DAOUsuarioJDBC("jdbc:sqlite:..\\AccesoDatos\\bdd\\ejemplocapas.s3db", null, null);
